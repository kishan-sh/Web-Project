        ...
        <div class="container">
			...
			<div class="st-container">
				...
				<div class="st-scroll">
					...
					<section class="st-panel" id="st-panel-1" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg14.jpg);background-size: cover;">
						<div class="st-deco" data-icon="H" style="background-color: #b06e3f;"></div>
					...
					<section class="st-panel" id="st-panel-3" style="background-color: black;">
						...
						<ul style="font-size: 20px; color: #fff; ">
								...
								<li style="color: #fff;"> 3 cups (400g) of quartered strawberriesr & 3/4 cup (173g) sour cream</li>
					...
					<section class="st-panel" id="st-panel-4" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg15.jpeg);background-size: cover;" >
						<div class="st-deco" data-icon="I" style="background-color:  #1c8314;"></div>
	   ...
	   while($row=$res->fetch_object())
	  {
	  	?>	
						...
						<div class="container" style="padding-top: 10%;">
							...
							<br>
										<input type="text" name="dish" value="pizza" >
									</div>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from feedback where dish='pizza'";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;
$res=$stmt->get_result();
