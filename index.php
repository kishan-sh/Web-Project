...
<section class="sec">
                ...
                <div class="main1">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                          ...
                          <a href="login.php"> <button>See Full Recipe</button></a>
                        </div>
                    </div>
                </div>
                <!-- Top Catagory Area -->
                ...
                <div class="main1">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                            <h3>French Toast</h3>
                            <h6>Simple &amp; Delicious</h6>
                             <a href="login.php"><button style="padding-left: 15px;">See Full Recipe</button></a>
                        </div>
                    </div>
                </div>
                <!-- Top Catagory Area -->
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb">
      <div id="img-hover-zoom">
        ...
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 >Sushi Zapanise</h4></a>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb">
      ...
      <a href="login.php" style="text-align: center;text-decoration: none;"><h4>Mexican Burger</h4></a>
      <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div  class="col-lg-4 col-md-4 col-xs-4 thumb">
      <div id="img-hover-zoom">
        ...
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4>Vegan Smoothie</h4></a>
       <div class="ratings" style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb">
     <div id="img-hover-zoom">
       <a href="login.php">
        ...
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 >Calabasa Soup</h4></a>
        <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb">
      ...
      <a href="login.php" style="text-align: center;text-decoration: none;"><h4 style="margin-top: -6%;">Mangolian Toast</h4></a>
      <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb">
       ...
       <div id="img-hover-zoom">
        ...
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4>Bali Fruit Salad</h4></a>
       <div class="ratings" style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
...
<br>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb" id="mini">
    <a href="login.php">
      <img class="img-responsive" src="img/bg-img/sr15.jpg" alt=""style="width: 85px; height: 80px;border-bottom: 3px solid #4BB543; cursor: pointer;"></a>
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Pulliyogre</h4></a>
        <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb" id="mini">
    <a href="login.php">
      ...
      <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Thatte Idli</h4></a>
      <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
 ...
 <a href="login.php">
      <img class="img-responsive" src="img/bg-img/sr11.jpg" alt=""style="width: 85px; height: 80px;border-bottom: 3px solid #4BB543; cursor: pointer;"></a>
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Uddin Vada </h4></a>
       <div class="ratings" style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb" id="mini">
    <a href="login.php">
      <img class="img-responsive" src="img/bg-img/sr12.jpg" alt=""style="width: 85px; height: 80px;border-bottom: 3px solid #4BB543; cursor: pointer;"></a>
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Masala Dosa</h4></a>
        <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb" id="mini">
    <a href="login.php">
      ...
      <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Poori Bhaji</h4></a>
      <div class="ratings"style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
  ...
  <div class="col-lg-4 col-md-4 col-xs-4 thumb" id="mini">
    <a href="login.php">
      <img class="img-responsive" src="img/bg-img/sr16.jpg" alt=""style="width: 85px; height: 80px;border-bottom: 3px solid #4BB543; cursor: pointer;"></a>
        <a href="login.php" style="text-align: center;text-decoration: none;"><h4 class="other">Aloo Paratha</h4></a>
       <div class="ratings" style="text-align: center; color: gold">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
