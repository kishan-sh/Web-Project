...
$log="insert into userlog(id,email) values('$uid','$uemail')";
$mysqli->query($log);
if($log)
{
...
body {
	background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/blog-img/5.jpg);	
...
<div class="container" style="margin-bottom: 150px;">
    ...
    <form class="form-signin" method="POST" action="">       
      ...
      <br>
      <p style="margin-left:-12%;margin-top: -14%;">New user? Click <a href="register.php">Here</a>.</p> 
