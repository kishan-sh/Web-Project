...
<html lang="en">
        ...
        <div class="container" >
			...
			<div class="st-container" style="margin-top: 0%;">
				...
				<div class="st-scroll">
					...
					<section class="st-panel" id="st-panel-1" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg41.jpg);background-size: cover;">
	...
	color: white;
						...
						<h2 style="color: white;">Aloo Paratha</h2>
					...
					<section class="st-panel" id="st-panel-4" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg42.jpg);background-size: cover;" >
						<div class="st-deco" data-icon="I" style="background-color:  #1c8314;"></div>
	   ...
	   while($row=$res->fetch_object())
	  {
	  	?>	
						...
						<div class="container" style="padding-top: 10%;">
							...
							<br>
										<input type="text" name="dish" value="tart" >
									</div>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from feedback where dish='tart'";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;
$res=$stmt->get_result();
