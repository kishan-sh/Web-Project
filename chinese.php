        ...
        <div class="container">
			...
			<div class="st-container">
				...
				<div class="st-scroll">
					...
					<section class="st-panel" id="st-panel-1" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg10.jpg);background-size: cover;">
						<div class="st-deco" data-icon="H" style="background-color: #d8eb63;"></div>
						<h2 style="color: white;">Chinese Noodles</h2>
					...
					<section class="st-panel" id="st-panel-3" style="background-color: black;">
						...
						<section class="st-panel" id="st-panel-4" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg11.jpg);background-size: cover;" >
						<div class="st-deco" data-icon="I" style="background-color:  #1c8314;"></div>
						...
						<div class="container" style="padding-top: 10%;">
							...
							<div class="st-deco" data-icon="P" style="background-color:  #1c8314;transform: translateY(70%);
								...
								top: -100%;"></div>
									...
									<i><h3 style="color: #fff;margin-top: -15%;">
										Hello <?php echo $row->fname;?>, What do you think about our recipe?, let us know below ; )
									</h3></i> 
							...
							<br>
										<input type="text" name="dish" value="chinese" >
									</div>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from feedback where dish='chinese'";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;
$res=$stmt->get_result();
...
<td style="border: none;"><h4 style="margin-left: 20%;margin-top: -20%;"><?php echo $row->fname;?> said "<i><span style="color: silver;"><?php echo $row->feedback;?>"</span></i></h4></td>
