        ...
        <div class="container">
			...
			<div class="st-container">
				...
				<div class="st-scroll">
					...
					<section class="st-panel" id="st-panel-1" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg21.jpg);background-size: cover;">
						<div class="st-deco" data-icon="H" style="background-color:#d11d80;"></div>
						<h2 style="color: white;">Vegan Smoothie</h2>
					...
					<section class="st-panel" id="st-panel-4" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/bg-img/bg20.jpg);background-size: cover;" >
						<div class="st-deco" data-icon="I" style="background-color:  #1c8314;"></div>
	   ...
	   while($row=$res->fetch_object())
	  {
	  	?>	
						...
						<div class="container" style="padding-top: 10%;">
							...
							<br>
										<input type="text" name="dish" value="smoothie" >
									</div>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from feedback where dish='smoothie'";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;
$res=$stmt->get_result();
